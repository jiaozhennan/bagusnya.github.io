...
export default function InquiryForm() {
  ...
  const propertyOptions = [
    ...
    { value: 'seaview-apartment', labelKey: 'property.features.seaview_apartment' },
    { value: 'city-center-duplex', labelKey: 'property.features.city_center_duplex' },
    { value: 'garden-villa', labelKey: 'property.features.garden_villa' },
          ...
          >
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">北京市朝阳区建国路88号优居大厦15层</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">周一至周日 9:00-21:00</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@youjudichan.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-2xl mb-8">
              ...
              <div className="space-y-2">
                {[
                  { dayKey: 'common.weekdays', time: '9:00 - 21:00' },
                  { dayKey: 'common.weekends', time: '10:00 - 18:00' },
                  { dayKey: 'common.holidays', time: '10:00 - 16:00' }
                ].map((item, index) => (
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  >
                    <i className={`fa-brands ${item.icon} text-xl`}></i>
                  </a>
                ))}
              </div>
            </div>
